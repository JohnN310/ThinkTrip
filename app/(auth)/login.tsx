    ...
    >
      ...
      >
        ...
        <View style={[styles.form, { backgroundColor: colors.card, borderColor: colors.border }]}>
          {errorMsg ? (
            <View style={[styles.errorBox, { backgroundColor: '#fbe7da', borderColor: colors.destructive + '33' }]}>
          ...
          {successMsg ? (
            <View style={[styles.errorBox, { backgroundColor: '#dff1e1', borderColor: '#15803d33' }]}>
              <Feather name="check-circle" size={16} color="#15803d" />
              <Text style={[styles.errorText, { color: '#14532d' }]}>{successMsg}</Text>
            </View>
          ) : null}
